        ...
        <div className='mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white lg:flex-row'>
            <div className='lg:w-[40%]'>
                <div className='flex flex-col gap-6 rounded-xl bg-gray-800 p-4 lg:p-6'>
                    {contactData.map((data,index)=>(
                        <div className='flex flex-col gap-[2px] p-3 text-sm text-gray-200' key={index}>
                            <div  className='flex flex-row items-center gap-3'>
                                ...
                                <h1 className="text-lg font-semibold text-gray-50">{data.title}</h1>
                            </div>
            ...
            <div className='lg:w-[60%]'>
                <div className='border border-gray-600 text-gray-300 rounded-xl p-7 lg:p-14 flex gap-3 flex-col'>
                    <h1 className="text-4xl leading-10 font-semibold text-gray-50">Got a Idea? We've got the skills. Let's team up</h1>
