        ...
        <div className='relative w-full bg-gray-800'>
            <div className='mx-auto box-content px-4 lg:w-[1260px] 2xl:relative '>
                <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
                   ...
                   <div className='z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-gray-50'>
                        <p className='text-4xl font-bold text-gray-50 sm:text-[42px]'>{courseName}</p>
                    ...
                    <div className='py-4'>
                        {
                            courseContent.map((section) => (
                                <div key={section._id} className='overflow-hidden border border-solid border-gray-600 bg-gray-700 text-gray-50 last:mb-0'>
                                    {/* Section */}
                                    ...
                                    {/* SubSections */}
                                    <div className={` ${isActive.includes(section._id) ? 'h-[88px]' : ''} relative h-0 overflow-hidden bg-gray-900 transition-[height] duration-[0.35s] ease-[ease]`}>
