...
const Catalog = () => {
    ...
    if(loading){
        return (
        <div className=' h-screen flex justify-center items-center text-gray-100 mx-auto  text-3xl'>
        <p>
                Loading...
        </p>
        </div>
        ...
        return (
            <>
                {
                    (!catalogPageData) ? 
                    (<div className=' text-center text-xl text-gray-300 my-8'> No Courses for the category </div>) 
                    :(
                        <>    
            <div className=" box-content bg-gray-800 px-4">
                <div className="mx-auto flex min-h-[260px] max-w-maxContentTab flex-col justify-center gap-4 lg:max-w-maxContent ">
                <p className="text-sm text-gray-300">{`Home / Catalog / `}
                <span className="text-yellow-25">
                    {catalogPageData?.name}
                </span></p>
                <p className="text-3xl text-gray-50"> {catalogPageData?.name} </p>
                <p className="max-w-[870px] text-gray-200"> {catalogPageData?.description}</p>
                </div>
            </div>
