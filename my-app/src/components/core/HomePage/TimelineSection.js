      ...
      <div className="flex flex-col lg:flex-row gap-20 mb-20 items-center">
              ...
              <div className="flex flex-col lg:gap-3" key={index}>
                ...
                <div
                  className={` ${index === 3 ? "hidden" : ""}   h-14 
                            border-dotted border-r border-gray-100 bg-gray-400/0 w-[26px]`}
                ></div>
              </div>
            );
          })}
        ...
        <div className="relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]">
          ...
          <div
            ...
            lg:translate-y-[50%] bg-green-950 top-0 lg:top-auto
          ...
          >
            <div className="flex gap-5 items-center lg:border-r border-green-300 px-7 lg:px-14">
              ...
              <p className="text-green-300 text-sm w-[75px]">
                Years of Experience
              </p>
            </div>
            ...
            <div className="flex gap-5 items-center lg:px-14 px-7">
              ...
              <p className="text-green-300 text-sm w-[75px]">TYpe of Courses</p>
            </div>
          </div>
        </div>
      </div>
