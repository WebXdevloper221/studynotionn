...
const CourseCard = ({cardData,currentCard,setCurrentCard}) => {
    return (
      <div className={` w-[360px] lg:w-[30%] h-[300px] box-border cursor-pointer
       ${currentCard === cardData.heading ? "bg-white shadow-[12px_12px_0_0] shadow-yellow-500  text-gray-700" 
       : "bg-gray-950  text-gray-100"}
       `} onClick={() => setCurrentCard(cardData.heading)}>
  
          <div className='flex flex-col gap-3 p-6 border-b-[2px] border-gray-400 border-dashed h-[80%]'>
